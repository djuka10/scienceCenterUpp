...
@Service
public class SavingArticleWithMinorChangesResult implements JavaDelegate{
	@Autowired
	...
	public void execute(DelegateExecution execution) throws Exception {
		...
		ArticleStatus articleStatus = ArticleStatus.MINOR_CHANGES;//ArticleStatus.valueOf(articleStatusString);
