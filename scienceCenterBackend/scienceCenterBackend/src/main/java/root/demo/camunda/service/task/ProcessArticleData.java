...
public class ProcessArticleData implements JavaDelegate {
	...
	@Autowired
	private MagazineEditionRepository magEdittionRepo;
	...
	public void execute(DelegateExecution execution) throws Exception {
		...
		//treba napraviti kao u saveArticle
		...
		MagazineEdition latestEdition = magEdittionRepo.findByMagazineOrderByPublishingDateDesc(magazine).stream().findFirst().orElse(null);
