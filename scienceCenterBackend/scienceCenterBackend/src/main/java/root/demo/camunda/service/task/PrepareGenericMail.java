	...
	public void execute(DelegateExecution execution) throws Exception {
		...
		switch (typeOfMessage) {
			...
			case "v1":
				...
				break;
			case "v2":
				messageMainPartAuthor = messageMainPartAuthor.replace("%xx%", " accepted with a minor changes in our magazine");
				executionVariableName = "endingMail";
				break;
			case "v3":
				messageMainPartAuthor = messageMainPartAuthor.replace("%xx%", " accepted with a major changes in our magazine");
				executionVariableName = "endingMail";
				break;
			case "v4":
				messageMainPartAuthor = messageMainPartAuthor.replace("%xx%", " rejected by editors and reviewers");
