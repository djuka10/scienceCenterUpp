...
export class RepositoryService {
  ...
  startProcess(process: string){
    return this.httpClient.get('http://localhost:8080/welcome/get/'.concat(process)) as Observable<any>
  }
  ...
  getUserTask(processInstance : string) {
    return this.httpClient.get('http://localhost:8080/welcome/get/userTask/'.concat(processInstance)) as Observable<any>
  }
